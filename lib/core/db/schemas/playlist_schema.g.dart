...
extension PlaylistQueryWhere on QueryBuilder<Playlist, Playlist, QWhereClause> {
  ...
  QueryBuilder<Playlist, Playlist, QAfterWhereClause> sourceEqualTo(
      String source) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterWhereClause> sourceNotEqualTo(
      String source) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Playlist, Playlist, QAfterWhereClause> sourceIdEqualTo(
      String sourceId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Playlist, Playlist, QAfterWhereClause> sourceIdNotEqualTo(
      String sourceId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
